...
<head>
  ...
  <link href="css\css-tablePhp.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
while($i<=10){
   $resultado = $i * $tabla;
   print("<li><span>".$i."</span>* 2 =".$resultado."</li>");
   $i++;
}
print("</ul>");
print("fin - 2");
...
for ($i=0; $i<=10; $i++){
   ...
   for ($tabla=0; $tabla<=10; $tabla++){
      print("<td>");	
      $resultado = $i * $tabla;
      print("<p><span class='a'>".$i."</span>*<span class='b'>".$tabla."</span>=".$resultado."</p>");
      print("</td>");
   }
   print("</tr>");
}
